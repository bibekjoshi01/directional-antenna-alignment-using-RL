...
\hline
RL (Q-learning) & $\mathbf{-46.55}$ & $\mathbf{8.62}$ & $\mathbf{57}$ & $\mathbf{95}$ & $\mathbf{1.18}$ \\
\hline
\end{tabular}
\end{adjustbox}
\end{table}
...
\hline
Outdoor, 30~m & $53.8 \pm 1.8$ s, 100\% & $10.8 \pm 2.2$ s, 80\% & $\mathbf{8.1 \pm 1.2}$ s, 100\% \\
\hline
Indoor, 10~m (LOS) & $55.1 \pm 2.0$ s, 100\% & $12.6 \pm 2.7$ s, 80\% & $\mathbf{8.9 \pm 1.5}$ s, 90\% \\
\hline
