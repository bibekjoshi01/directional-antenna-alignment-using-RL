...
\item The deployed controller was limited to the practical search region used during hardware testing so that the state space remained compact and physically meaningful
\end{itemize}
